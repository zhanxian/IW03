...
import static org.opencv.samples.tutorial2.OverlayView.DEBUG_TAG;
...
public class Tutorial2Activity extends Activity implements CvCameraViewListener2, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mapAct.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view){
                ...
                mapActivity.putExtra("aqi", aqi);
                mapActivity.putExtra("temp", temp);
                mapActivity.putExtra("inter", inter);
                mapActivity.putExtra("streets", street);
    ...
    public void getIntersections(){
        ...
        JsonObjectRequest jsObjRequest = new JsonObjectRequest(Request.Method.GET, url+mCurrentLocation.getLatitude()+"&lng="+mCurrentLocation.getLongitude()+"&maxRows=2" +
